 ...
 */
  ...
  function bookstore_render_booklist() {
    ?>
    <div class="wrap" id="bookstore_booklist_admin">
      <h1>Actions</h1>
    ...
    <div style="width:50%;" >
      ...
      <form>
        ...
        <div>
          <input type="button" id="bookstore-submit-book" value="Add Book" />
        </div>
      </form>
    </div>
    <?php
  ...
  function bookstore_enqueue_scripts() {
    ...
    wp_enqueue_script( 'bookstore-script', plugins_url() . '/bookstore/bookstore.js', array('jquery'), '1.0', true );
  }

  add_action( 'admin_enqueue_scripts', 'bookstore_admin_enqueue_scripts' );
  function bookstore_admin_enqueue_scripts() {
    wp_enqueue_style( 'bookstore-admin-style', plugins_url() . '/bookstore/bookstore.css' );
    wp_enqueue_script( 'bookstore-admin-script', plugins_url() . '/bookstore/admin_bookstore.js', array('wp-api', 'wp-api-fetch'), '1.0.0', true );
  }
